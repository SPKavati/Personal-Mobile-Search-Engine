...
<div class="main">
  <div class="main_resize">
        ...
        <div class="mainbar">
          ...
          <div class="article">
            ...
            <!--Non-Geo Based(Content)-->
				<div class="article">
            <h2><span>Non-Geo Based Search Result(Content)</span> </h2>
            <div class="clr"></div>
            
	<%
		String sta="content concept";
		String nchild=null;		
	...
	try{		
			...
			String sql6="select * from ontology where country='"+search+"' and concept='"+sta+"' ";
...
%>
 <%
	...
	try{
			...
			while(rs7.next()){	%>			
				...
				<div class="comment"> 
				<p> Title:--<a href="contentcount.jsp?id=<%=rs7.getInt("id")%>,<%=rs7.getString("contentname")%>"><font color="#FF0000" size="+2"><%=rs7.getString("title")%></font></a></p>
				<p>Views:--<a><font color="#0000FF" size="+2"><%=rs7.getInt("count")%></font></a></p>
				<p>Description:&nbsp;&nbsp;<%=rs7.getString("description")%></p>
				</div>		
 ...
 %>
        ...
        <div class="sidebar">
          <div class="gadget">
            <h2 class="star"><span>Content </span> Ontology</h2>
            <div class="clr"></div>
            <ul class="sb_menu">
          ...
          <div class="gadget">
            <h2 class="star"><span>Geo-Based Search(Location)</span></h2>
            <div class="clr"></div>
            <ul class="ex_menu">
...
for(int p=0;p<tempquery.length;p++)
           				{
							...
							try{
								...
								while(rs8.next()){
								myid1=rs8.getInt("sid");
									try {
								
											PreparedStatement ps=con.prepareStatement("update templocation set count=? where id='"+myid1+"' ");
 ...
 <%
	...
	try{
			...
			while(rs3.next()){	%>			
				...
				<li class="active"><a href="locationcount.jsp?id=<%=rs3.getInt("id")%>,<%=rs3.getString("locationname")%>"><%=rs3.getString("title")%></a></li>
