 ...
 <%
	...
	try{
			...
			while(rs3.next()){	%>			
				...
				<div class="comment">
				<p><a href="#">Title:--<a href="locationcount.jsp?id=<%=rs3.getInt("id")%>,<%=rs3.getString("locationname")%>"><font color="#FF0000" size="+2"><%=rs3.getString("title")%></font></a></p>
 ...
 <%
	...
	try{
			...
			while(rs7.next()){	%>			
				...
				<div class="comment"> 
				<p><a href="#"> Title:--<a href="contentcount.jsp?id=<%=rs7.getInt("id")%>,<%=rs7.getString("contentname")%>"><font color="#FF0000" size="+2"><%=rs7.getString("title")%></font></a></p>
